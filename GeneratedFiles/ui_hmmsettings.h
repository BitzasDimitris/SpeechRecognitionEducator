...
public:
    ...
    {
        HMMSettings->setWindowTitle(QApplication::translate("HMMSettings", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("HMMSettings", "GMM Quality", Q_NULLPTR));
        QualitySpinner->setSuffix(QApplication::translate("HMMSettings", "%", Q_NULLPTR));
        label_3->setText(QApplication::translate("HMMSettings", "Initial Samples Per Phoneme", Q_NULLPTR));
        MaxVecSpinner->setSuffix(QString());
        label_4->setText(QApplication::translate("HMMSettings", " 0 for All ", Q_NULLPTR));
        label_5->setText(QApplication::translate("HMMSettings", "Cross Validation Percentage", Q_NULLPTR));
        label_6->setText(QApplication::translate("HMMSettings", "<html><head/><body><p>0 for evaluation of </p><p>complete Training Set</p></body></html>", Q_NULLPTR));
        CrossSpinner->setSuffix(QApplication::translate("HMMSettings", "%", Q_NULLPTR));
        SilenceBox->setText(QApplication::translate("HMMSettings", "Model Silence", Q_NULLPTR));
    } // retranslateUi
