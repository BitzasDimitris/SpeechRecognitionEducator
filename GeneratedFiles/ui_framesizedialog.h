...
public:
    ...
    {
        FrameSizeDialog->setWindowTitle(QApplication::translate("FrameSizeDialog", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("FrameSizeDialog", "Frame Size in ms:", Q_NULLPTR));
        label_2->setText(QApplication::translate("FrameSizeDialog", "Overlapping in ms:", Q_NULLPTR));
    } // retranslateUi
