...
public:
    ...
    {
        FramesWindow->setWindowTitle(QApplication::translate("FramesWindow", "Dialog", Q_NULLPTR));
        sizelabel->setText(QApplication::translate("FramesWindow", "TextLabel", Q_NULLPTR));
        label->setText(QApplication::translate("FramesWindow", "Frame:", Q_NULLPTR));
        CurrentFrame->setText(QApplication::translate("FramesWindow", "1", Q_NULLPTR));
    } // retranslateUi
