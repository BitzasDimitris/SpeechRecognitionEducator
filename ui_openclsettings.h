...
public:
    ...
    {
        OpenClSettings->setWindowTitle(QApplication::translate("OpenClSettings", "Dialog", 0));
        label->setText(QApplication::translate("OpenClSettings", "Availiable Platforms:", 0));
        label_2->setText(QApplication::translate("OpenClSettings", "Availiable Devices", 0));
    } // retranslateUi
