...
public:
    ...
    {
        AudioSettingsDialog->setWindowTitle(QApplication::translate("AudioSettingsDialog", "Dialog", 0));
        label->setText(QApplication::translate("AudioSettingsDialog", "Recognition Sample Rate:", 0));
    } // retranslateUi
